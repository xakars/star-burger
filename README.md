...
Опционально, для включения системы логирования rollbar, следует задать настройки:
...
Также проект можно запустить с помощью docker-compose:
```sh
docker compose up -d --build
```

Проект развернут на домене [arsxak.ru](http://129.151.80.13:8179/)
## Цели проекта
